import { ISize, IGender, IType, IRole } from '../interfaces'
import bcrypt from 'bcryptjs'

/**
 * Contract for defining product data types
 */
...
/**
 * Contract for defining user data types
 */
interface SeedUser {
	email: string
	name: string
...
/**
 * Contract for defining data types
 */
interface SeedData {
