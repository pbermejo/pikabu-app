...
/**
 * Page component for checkout summary
 * @returns component layout in html
 */
const SummaryPage = () => {
	const router = useRouter()
	const { shippingAddress, summary, createOrder } = useContext(CartContext)
	...
	return (
		<ShopLayout title='Pedido - 3' pageDescription='Resumen de pedido'>
					...
					<Card className='summary-card'>
						<CardContent>
							<Typography variant='h2'>
								Pedido ({`${numberOfItems} ${numberOfItems === 1 ? 'pedido' : 'pedidos'}`})
							</Typography>
							<Divider sx={{ my: 1 }} />
